...
sudo cp steam/steam /usr/bin/
echo "Flatpak in steam command done.."

sudo cp -r ../../.var/app/com.valvesoftware.Steam/.local/share/icons ../../.local/share/
echo Icons done..
sudo cp -r ../../.var/app/com.valvesoftware.Steam/.local/share/applications/ ../../.local/share/
